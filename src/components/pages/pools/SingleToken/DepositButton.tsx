        ...
        <>
          <Box className='flex justify-between'>
            ...
            {loadingShare ? (
              ...
              <p>{formatNumber(vaultShare)}%</p>
            )}
          </Box>
          <Box
            className={`${styles.singleTokenInfoWrapper} ${styles.singleTokenHelp}`}
            mt={2}
          >
            <HelpIcon />
            <small>
          ...
          <Box
            className={`${styles.singleTokenInfoWrapper} ${styles.singleTokenWarning}`}
            my={2}
          >
            <ReportProblem />
